function calculateRSI_OLD_2000(prices, period) {
...
for(let i=0; i<4000; i++){
    if(i % 500 === 0) p += 50; // spike gigante cada 500 ticks 
    p -= 0.2; // always drop
    history.push(p);
}
console.log("RSI 14 (old way - 2000 suavizado):", calculateRSI_OLD_2000(history, 14));
