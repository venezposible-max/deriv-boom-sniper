...
// Fecha: 7 de Marzo de 2026 (Hace 4 días)
...
const CONFIG = {
    ...
    multiplier: 200,
    timeStopTicks: 50,
    rsiThreshold: 75, // Mantenemos el nivel de seguridad nuevo
    antiSpikeLimit: 0.1,
    harvestMaxTicks: 300,
...
ws.on('open', () => {
    console.log(`📥 Descargando DATA TICKS para BOOM 500 (Fecha: 2026-03-07)...`);
    fetchTicks(endTS);
});
...
ws.on('message', (data) => {
    ...
    if (msg.msg_type === 'history') {
        ...
        // Agregar al inicio para ir hacia atrás en el tiempo
...
function runTrendGrinderBacktest() {
    ...
    console.log("\n=========================================");
    console.log("🌾 TREND GRINDER: BOOM 500 (Hace 4 Días)");
    console.log("=========================================");
    console.log(`Fecha Auditoría: 7 de Marzo, 2026`);
